...
<body id="main">
    <div class="map">
        管理首页>>等级管理>><strong title="{$title}" id="title">{$title}</strong>
    </div>
    <ol>
    ...
    {if $add}
        <form action="" method="post" name="add">
            <table class="left">
                ...
                <tr><td><input type="submit" name="send" class="submit level" value="新增等级" onclick="return checkForm();"> [ <a href="{$prev_url}">返回列表</a> ]</td></tr>
            </table>
        </form>
    {/if}
    ...
    {if $update}
        <form action="" method="post" name="add">
            ...
            <table class="left">
                ...
                <tr><td><input type="submit" name="send" class="submit level" value="修改等级" onclick="return checkForm();"> [ <a href="{$prev_url}">返回列表</a> ]</td></tr>
            </table>
        </form>
    {/if}
